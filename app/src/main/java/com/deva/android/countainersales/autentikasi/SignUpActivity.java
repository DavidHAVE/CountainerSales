                        ...
                        .addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    userId = user.getUid();
                                    firebaseHandler = new FirebaseHandler(getApplicationContext(), userId);
                                    ...
                                    //    textView.setText(user.getDisplayName().toString());
                                    ...
                                    //mProfileDatabaseReference.push().getKey();
                                    UserProfile userProfile = new UserProfile(userId, "", email, "", "", true);
                                    firebaseHandler.getRefProfileUser().setValue(userProfile);
