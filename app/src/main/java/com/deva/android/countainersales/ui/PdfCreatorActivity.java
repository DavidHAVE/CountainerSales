...
//    ProductListAllPDF productListAllPDF;
...
//        productListAllPDF = new ProductListAllPDF();

        pdfInvoiceGenerate = new PDFInvoiceGenerate();

//        pdfInvoiceGenerate.createPDF(this, "invoice", "satu", "dua");
...
//                    createPdfWrapper();
//                    createPdf();
//                    productListAllPDF.createPDF(getApplicationContext(), "report");
